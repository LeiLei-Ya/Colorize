...
sys.path.append(os.path.join(parent_dir, 'basicsr'))
...
def main():
    ...
    parser.add_argument('--model_path', type=str, default='modelscope/damo/cv_ddcolor_image-colorization/pytorch_model.pt')
    parser.add_argument('--input', type=str, default='./test_imgs', help='input test image folder or video path')
    parser.add_argument('--output', type=str, default='./colorize_output', help='output folder or video path')
